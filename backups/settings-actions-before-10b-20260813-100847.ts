...
export async function saveWorkspaceSettings(
  ...
  const defaultPlatform = String(
    formData.get("default_platform") ??
      "linkedin"
  );

  const defaultTone = String(
    formData.get("default_tone") ??
      "professional"
  );
