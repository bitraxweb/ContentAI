...
export function ProtectedShell({
  ...
  const canCreate = ["editor", "admin", "super_admin"].includes(role);
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      href: canCreate ? "/protected/create" : undefined,
      icon: "plus",
      disabled: !canCreate,
    },
    {
    ...
    },
    {
      ...
      href: canManageUsers ? "/protected/users" : undefined,
      icon: "users",
