        ...
        <section className="relative hidden overflow-hidden p-12 lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="relative max-w-xl">
            ...
            <h1 className="mt-4 text-5xl font-bold leading-tight tracking-tight text-white">
              Empieza a organizar tu contenido profesionalmente.
            </h1>

            <p className="mt-5 max-w-lg text-base leading-7 text-slate-300">
              Los usuarios autorizados podrán crear y gestionar contenido
              desde un único espacio de trabajo.
            </p>
          </div>

          <p className="relative text-xs text-slate-500">
            La administración de roles se habilitará en el próximo módulo.
          </p>
        </section>
